...
var types = ['Array', 'Boolean', 'Date', 'Error', 'Class', 'Function', 'Null', 'Number', 'RegExp', 'String', 'Undefined', 'Map', 'WeakMap', 'Object' // deliberately last, as this is a catch all
];
...
var typeChecker = {
	...
	getType: function getType(value) {
		// Cycle
		for (var i = 0, n = types.length, type; i < n; ++i) {
			type = types[i];
