...
(function() {
  var Backbone, FileModel, Model, TaskGroup, balUtil, docpadUtil, encodingUtil, extendr, extractOptsAndCallback, jschardet, mime, pathUtil, safefs, typeChecker, _ref, _ref1,
        ...
        if (isText === true) {
          ...
          if (docpadUtil.isStandardEncoding(encoding) === false) {
            ...
            if (encodingUtil != null) {
              ...
              d.run(function() {
                return buffer = encodingUtil.convert(buffer, 'utf8', encoding);
              });
            } else {
    ...
    FileModel.prototype.write = function(opts, next) {
      ...
      if ((_ref3 = opts.encoding.toLowerCase()) !== 'ascii' && _ref3 !== 'utf8' && _ref3 !== 'utf-8' && _ref3 !== 'binary') {
        ...
        if (encodingUtil != null) {
          ...
          try {
            opts.content = encodingUtil.convert(opts.content, opts.encoding, 'utf8');
          } catch (_error) {
            err = _error;
