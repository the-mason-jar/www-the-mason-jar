...
DocPad = (function(_super) {
  ...
  */
  ...
  DocPad.prototype.run = function(opts, next) {
    var check, config, docpad, finish, locale, rootPath, run, srcPath, _ref1;
    _ref1 = extractOptsAndCallback(opts, next), opts = _ref1[0], next = _ref1[1];
    docpad = this;
    locale = this.getLocale();
    config = this.getConfig();
    ...
    check = function(complete) {
      var desiredDocPadVersion, _ref2, _ref3;
      desiredDocPadVersion = String(((_ref2 = docpad.websitePackageConfig) != null ? (_ref3 = _ref2.dependencies) != null ? _ref3.docpad : void 0 : void 0) || '').replace('~', '');
      if (!desiredDocPadVersion || desiredDocPadVersion === docpad.version) {
        return complete();
      }
